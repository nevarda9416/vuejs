...
Vue.use(vue_axios__WEBPACK_IMPORTED_MODULE_0__["default"], (axios__WEBPACK_IMPORTED_MODULE_1___default()));
Vue.component('coin-add-component', __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/AddComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
var app = new Vue({
  el: '#app'
});
